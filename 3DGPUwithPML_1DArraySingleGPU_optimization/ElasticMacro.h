...
*/
#define VelocityPMLUpdate( AREA, dampingMinusX, MUTIx, dampingMinusY, MUTIy, dampingMinusZ, MUTIz, DIVIDEx, dampingPlusX, DIVIDEy, dampingPlusY, DIVIDEz, dampingPlusZ ) \
		...
		diffY /= delta.y;\
		diffZ /= delta.z;\
		vsPML[AREA].velocityXx[index] = ( dampingMinusX MUTIx vsPML[AREA].velocityXx[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffX ) DIVIDEx dampingPlusX;\
		vsPML[AREA].velocityXy[index] = ( dampingMinusY MUTIy vsPML[AREA].velocityXy[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffY ) DIVIDEy dampingPlusY;\
		vsPML[AREA].velocityXz[index] = ( dampingMinusZ MUTIz vsPML[AREA].velocityXz[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffZ ) DIVIDEz dampingPlusZ;\
		...
		diffY /= delta.y;\
		diffZ /= delta.z;\
		vsPML[AREA].velocityYx[index] = ( dampingMinusX MUTIx vsPML[AREA].velocityYx[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffX ) DIVIDEx dampingPlusX;\
		vsPML[AREA].velocityYy[index] = ( dampingMinusY MUTIy vsPML[AREA].velocityYy[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffY ) DIVIDEy dampingPlusY;\
		vsPML[AREA].velocityYz[index] = ( dampingMinusZ MUTIz vsPML[AREA].velocityYz[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffZ ) DIVIDEz dampingPlusZ;\
		...
		diffY /= delta.y;\
		diffZ /= delta.z;\
		vsPML[AREA].velocityZx[index] = ( dampingMinusX MUTIx vsPML[AREA].velocityZx[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffX ) DIVIDEx dampingPlusX;\
		vsPML[AREA].velocityZy[index] = ( dampingMinusY MUTIy vsPML[AREA].velocityZy[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffY ) DIVIDEy dampingPlusY;\
		vsPML[AREA].velocityZz[index] = ( dampingMinusZ MUTIz vsPML[AREA].velocityZz[index] + delta.t * BUOYANCYBARX(medGPU.buoyancy, ix, iy, iz) * diffZ ) DIVIDEz dampingPlusZ;\
		vsGPU.velocityZ[INDEX(ix, iy, iz)] = vsPML[AREA].velocityZx[index] + vsPML[AREA].velocityZy[index] + vsPML[AREA].velocityZz[index];


#define StressPMLUpdate( AREA, dampingMinusX, MUTIx, dampingMinusY, MUTIy, dampingMinusZ, MUTIz, DIVIDEx, dampingPlusX, DIVIDEy, dampingPlusY, DIVIDEz, dampingPlusZ ) \
		...
		diffZ /= delta.z;\
		\
		vsPML[AREA].stressXXx[index] = ( dampingMinusX MUTIx vsPML[AREA].stressXXx[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] + 2.0f * medGPU.mu[INDEX(ix, iy, iz)] ) * diffX ) DIVIDEx dampingPlusX;\
		vsPML[AREA].stressXXy[index] = ( dampingMinusY MUTIy vsPML[AREA].stressXXy[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] * diffY ) ) DIVIDEy dampingPlusY;\
		vsPML[AREA].stressXXz[index] = ( dampingMinusZ MUTIz vsPML[AREA].stressXXz[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] * diffZ ) ) DIVIDEz dampingPlusZ;\
		vsGPU.stressXX[INDEX(ix, iy, iz)] = vsPML[AREA].stressXXx[index] + vsPML[AREA].stressXXy[index] + vsPML[AREA].stressXXz[index];\
		\
		vsPML[AREA].stressYYx[index] = ( dampingMinusX MUTIx vsPML[AREA].stressYYx[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] * diffX ) ) DIVIDEx dampingPlusX;\
		vsPML[AREA].stressYYy[index] = ( dampingMinusY MUTIy vsPML[AREA].stressYYy[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] + 2.0f * medGPU.mu[INDEX(ix, iy, iz)] ) * diffY ) DIVIDEy dampingPlusY;\
		vsPML[AREA].stressYYz[index] = ( dampingMinusZ MUTIz vsPML[AREA].stressYYz[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] * diffZ ) ) DIVIDEz dampingPlusZ;\
		vsGPU.stressYY[INDEX(ix, iy, iz)] = vsPML[AREA].stressYYx[index] + vsPML[AREA].stressYYy[index] + vsPML[AREA].stressYYz[index];\
		\
		vsPML[AREA].stressZZx[index] = ( dampingMinusX MUTIx vsPML[AREA].stressZZx[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] * diffX ) ) DIVIDEx dampingPlusX;\
		vsPML[AREA].stressZZy[index] = ( dampingMinusY MUTIy vsPML[AREA].stressZZy[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] * diffY ) ) DIVIDEy dampingPlusY;\
		vsPML[AREA].stressZZz[index] = ( dampingMinusZ MUTIz vsPML[AREA].stressZZz[index] + delta.t * ( medGPU.lambda[INDEX(ix, iy, iz)] + 2.0f * medGPU.mu[INDEX(ix, iy, iz)] ) * diffZ ) DIVIDEz dampingPlusZ;\
		...
		diffX /= delta.x;\
		diffY /= delta.y;\
		vsPML[AREA].stressXYx[index] = ( dampingMinusX MUTIx vsPML[AREA].stressXYx[index] + delta.t * muBarXY * diffX ) DIVIDEx dampingPlusX;\
		vsPML[AREA].stressXYy[index] = ( dampingMinusY MUTIy vsPML[AREA].stressXYy[index] + delta.t * muBarXY * diffY ) DIVIDEy dampingPlusY;\
		...
		diffX /= delta.x;\
		diffZ /= delta.z;\
		vsPML[AREA].stressXZx[index] = ( dampingMinusX MUTIx vsPML[AREA].stressXZx[index] + delta.t * muBarXZ * diffX ) DIVIDEx dampingPlusX;\
		vsPML[AREA].stressXZz[index] = ( dampingMinusZ MUTIz vsPML[AREA].stressXZz[index] + delta.t * muBarXZ * diffZ ) DIVIDEz dampingPlusZ;\
		...
		diffY /= delta.y;\
		diffZ /= delta.z;\
		vsPML[AREA].stressYZy[index] = ( dampingMinusY MUTIy vsPML[AREA].stressYZy[index] + delta.t * muBarYZ * diffY ) DIVIDEy dampingPlusY;\
		vsPML[AREA].stressYZz[index] = ( dampingMinusZ MUTIz vsPML[AREA].stressYZz[index] + delta.t * muBarYZ * diffZ ) DIVIDEz dampingPlusZ;\
